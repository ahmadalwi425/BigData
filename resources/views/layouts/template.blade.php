...
<html lang="en">
  ...
  <body>
    ...
    <!-- FOOTER -->
    <div id="bg-dark" class="container-fluid bg-dark my-bg py-3 text-white">
        <div class="row my-bg justify-content-center text-center">
            <div class="row justify-content-center">
                <div class="col-lg-1 mb-1 col-12"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    width="24" height="24"
                    viewBox="0 0 172 172"
            ...
            <div class="row justify-content-center mt-3">
                <div class="col-lg-1 col-12">2021 BEM KBM INSTITUT TEKNOLOGI PLN</div>
            </div>
        </div>
    </div>
