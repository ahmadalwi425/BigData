...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2021 at 04:04 PM
...
(6, 'img/IMG_6877.JPG', 'bul tes kat 1', 'dsfsfssdf', 1);
...
INSERT INTO `daftar_ormawa` (`id`, `id_ormawa`, `id_user`, `created_at`) VALUES
(1, 1, 1, '2021-09-22 17:49:56'),
(9, 1, 1, '2021-09-14 17:49:56'),
(10, 2, 1, '2021-09-19 17:00:00'),
(11, 3, 1, '2021-09-05 17:49:56'),
(12, 3, 2, '2021-10-02 03:11:18');
...
INSERT INTO `pembelian` (`id`, `id_pembeli`, `id_produk`, `total_harga`, `qty`, `bukti`, `tanggal`, `status`) VALUES
(1, 1, 1, 700000, 2, NULL, '2021-09-26 07:58:38', 'menunggu konfirmasi');
...
(2, 112233, 'user2', 'user2@user.com', NULL, '$2y$10$xJ1hv4KmzcyQXot4kUfZdOfhO4mRt60Tc7zZy3VEpJ4RLkY8Lw8Ae', 237832, 2, 2, NULL, '2021-08-11 07:12:26', NULL);
